...
type AgentToServerTestRequest struct {
	...
	// Port number to use for the test.
...
// UpdateAgentToServerTestRequest is generated from the OpenAPI specification.
type UpdateAgentToServerTestRequest struct {
	Agents TestAgentsWithSourceIpRequest `json:"agents,omitempty"`
	// List of alert rules IDs to apply to the test (get `ruleId` from
	// `/alerts/rules` endpoint.
	AlertRules []string `json:"alertRules,omitempty"`
	// Indicates if alerts are enabled.
