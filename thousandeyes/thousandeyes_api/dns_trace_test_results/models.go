...
// DnsTraceTestResult is generated from the OpenAPI specification.
type DnsTraceTestResult struct {
	...
	FinalQueryTime *int `json:"finalQueryTime,omitempty"`
...
// DnsTraceTestResults is generated from the OpenAPI specification.
