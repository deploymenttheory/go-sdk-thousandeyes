...
// AgentClusterAssignRequest is generated from the OpenAPI specification.
type AgentClusterAssignRequest struct {
	// Contains list of agent IDs (get `agentId` from `/agents` operation)
	Agents []string `json:"agents,omitempty"`
}

// AgentClusterUnassignRequest is generated from the OpenAPI specification.
type AgentClusterUnassignRequest struct {
	// Contains list of member IDs.
