...
// ConnectedDevices Configuration for Connected Devices metric data in the
// stream integration.
...
type CreateStreamResponse struct {
	...
	Name              StreamName        `json:"name,omitempty"`
...
// InputConfig Configuration that specifies which input data is included for
// each signal.
type InputConfig struct {
	Metric *InputConfigMetric `json:"metric,omitempty"`
}

// InputConfigMetric Configuration for metric input data in the stream
// integration.
...
// StreamName Name of the data stream. When omitted, a name is generated on
// creation and the existing name is preserved on update.
