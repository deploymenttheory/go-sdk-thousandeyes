...
// ApiListWidgetLegend Map of legend labels to their counts for the **List**
// widget.
type ApiListWidgetLegend map[string]int

// ApiListWidgetRow A row in a **List** widget. Property names are dimension
// display labels mapped to their values for that row.
...
// ApiListWidgetRows Detailed information about each row in the **List**
// widget.
type ApiListWidgetRows []ApiListWidgetRow
...
type ApiWidgetsDataV2 struct {
	...
	Legend                  ApiListWidgetLegend        `json:"legend,omitempty"`
	Points                  []ApiWidgetDataPoint       `json:"points,omitempty"`
	Rows                    ApiListWidgetRows          `json:"rows,omitempty"`
...
// CloneDashboardRequest Optional values that override settings inherited from
// the source dashboard. Omit the request body or send an empty object (`{}`)
// to clone the dashboard without overrides.
type CloneDashboardRequest struct {
	DefaultTimespan *DefaultTimespan `json:"defaultTimespan,omitempty"`
	// Description for the cloned dashboard.
	Description *string `json:"description,omitempty"`
	// Global filter applied to the cloned dashboard.
	GlobalFilterID *string `json:"globalFilterId,omitempty"`
	// When `true`, sets the cloned dashboard as the current account group's
	// default dashboard.
	IsDefaultForAccount *bool `json:"isDefaultForAccount,omitempty"`
	// When `true`, sets the cloned dashboard as the current user's default
	// dashboard.
	IsDefaultForUser *bool `json:"isDefaultForUser,omitempty"`
	// If `true`, the dashboard time range overrides local widget time settings.
	IsGlobalOverride *bool `json:"isGlobalOverride,omitempty"`
	// When `true`, only the creator can view the cloned dashboard.
	IsPrivate *bool `json:"isPrivate,omitempty"`
	// When `true`, shares the cloned dashboard with all account groups available
	// to the user.
	...
	// Account group IDs with which to share the cloned dashboard.
	SharedAccountIds []AccountGroupId `json:"sharedAccountIds,omitempty"`
	// Dashboard tag identifiers.
	TagIds TagIds `json:"tagIds,omitempty"`
	// Title of the cloned dashboard.
	Title *string `json:"title,omitempty"`
}
...
// DashboardSchedule Snapshot schedule for a dashboard. A `repeat` value of
// `NONE` represents a one-time schedule.
type DashboardSchedule struct {
	...
	// When `true`, generated snapshots are automatically shared with schedule
	// recipients.
	FlagAutoShare *bool `json:"flagAutoShare,omitempty"`
	// When `true`, the schedule is active and snapshots are generated according to
	// `cronSpec`.
	FlagEnabled bool `json:"flagEnabled"`
	// When `true`, generated snapshots include personally identifiable user data
	// when permitted by account policy.
	FlagIsIncludePiiUserData *bool `json:"flagIsIncludePiiUserData,omitempty"`
	// When `true`, the schedule configuration is locked and cannot be edited
	// through the web application.
	FlagLocked *bool `json:"flagLocked,omitempty"`
	// UTC date of the next scheduled snapshot run.
	NextDate *string `json:"nextDate,omitempty"`
	// Email addresses of active dashboard account users who receive snapshot
	// notifications.
	Recipients []string `json:"recipients,omitempty"`
}

// DashboardScheduleAfterEndCondition is generated from the OpenAPI specification.
...
// DashboardScheduleCustomCronSpec is generated from the OpenAPI specification.
type DashboardScheduleCustomCronSpec struct {
	...
	// An IANA time zone identifier used to interpret `startTime` and recurrence.
	ZoneCode string `json:"zoneCode"`
}

// DashboardScheduleCustomRepeat is generated from the OpenAPI specification.
type DashboardScheduleCustomRepeat struct {
	// Days of the week for custom weekly recurrence (`1` = Monday through `7` =
	// Sunday).
...
// DashboardScheduleDataSource Naming configuration for snapshots generated by
// the schedule. The required `dataTimespan` property on the schedule controls
// the snapshot data range.
type DashboardScheduleDataSource struct {
	// Name assigned to snapshots generated by the schedule.
	Name string `json:"name"`
}

// DashboardScheduleDateEndCondition is generated from the OpenAPI specification.
...
// DashboardScheduleNeverEndCondition is generated from the OpenAPI specification.
type DashboardScheduleNeverEndCondition struct {
	// Identifies a schedule that never ends.
	EndConditionType string `json:"endConditionType"`
}

// DashboardScheduleNonCustomCronSpec is generated from the OpenAPI specification.
...
// DashboardScheduleRequest Snapshot schedule configuration for create or
// update requests.
...
// DashboardScheduleTimespan Amount of historical data to include in each
// scheduled snapshot.
