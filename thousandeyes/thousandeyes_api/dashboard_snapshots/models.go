...
type ApiDashboardSnapshot struct {
	...
	SnapshotCreatedDate    *string                `json:"snapshotCreatedDate,omitempty"`
...
type DashboardSnapshotId string
...
// GenerateDashboardSnapshotRequest Request to generate a snapshot from a
// dashboard.
type GenerateDashboardSnapshotRequest struct {
	...
	EndDate        *string                `json:"endDate,omitempty"`
	ExpirationDate SnapshotExpirationDate `json:"expirationDate,omitempty"`
...
// SnapshotExpirationDate Expiration date of the snapshot. If unspecified, the
// snapshot expires 1 year from its creation date. The expiration date must be
// set within 5 years from the current date and adhere to the ISO date-time
// format.
type SnapshotExpirationDate string
...
// UpdateSnapshotExpirationDateApiRequest Request to update the expiration date
// of a snapshot.
